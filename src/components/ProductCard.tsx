...
const ProductCard = ({
  ...
  const handleQuickAdd = (e: React.MouseEvent) => {
    ...
    addToCart({
      ...
      price,
      image,
      size: "US 9", // Default size for quick add
      quantity: 1,
    });

    toast({
      title: "Added to cart!",
      description: `${name} (US 9) added to your cart`,
    });
        ...
        <div className="relative aspect-square overflow-hidden bg-secondary">
          ...
          >
            <button
              ...
              className="w-full py-3 bg-primary text-primary-foreground font-display uppercase tracking-wider text-sm flex items-center justify-center gap-2 hover:bg-primary/90 transition-colors"
            >
